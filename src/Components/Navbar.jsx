...
const Navbar = () => {
    ...
    return (
        <div className="absolute top-0 left-0 w-full z-10">
            <div className="container mx-auto flex justify-between items-center py-4 px-6 md:px-2 lg:px-32 bg-transparent">
                ...
                <button className="hidden md:block bg-white px-8 py-2 rounded-full hover:cursor-pointer hover:scale-110 transition-transform duration-300">Sign up</button>
