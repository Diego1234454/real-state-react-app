...
const Projects = () => {
    ...
    useEffect(() => {
        const updatedCardsToShow = () => {
            ...
            window.addEventListener('resize', updatedCardsToShow);

            return () => window.removeEventListener('resize', updatedCardsToShow);
    ...
    return (
        ...
        <motion.div
            ...
            <div className="flex justify-end items-center mb-8">
                <button onClick={prevProject} className="p-3 bg-gray-200 rounded mr-2 hover:cursor-pointer" aria-label="Previous Project">
                    <img src={assets.left_arrow} alt="Previous"/>
                </button>
                <button onClick={nextProject} className="p-3 bg-gray-200 rounded mr-2 hover:cursor-pointer" aria-label="Next Project">
